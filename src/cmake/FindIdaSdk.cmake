...
#   IDASDK_ROOT      - Preferred installation prefix (evironment variable)
#
...
find_package_handle_standard_args(
  IdaSdk FOUND_VAR IdaSdk_FOUND
         REQUIRED_VARS IdaSdk_DIR
                       IdaSdk_INCLUDE_DIRS
         FAIL_MESSAGE "IDA SDK not found, try setting IdaSdk_ROOT_DIR or IDASDK_ROOT env var")
...
function(_ida_common_target_settings t ea64)
  ...
  target_include_directories(${t} SYSTEM PRIVATE ${IdaSdk_INCLUDE_DIRS})
endfunction()
...
function(ida_target_include_directories name)
  foreach(target ${name}${_so} ${name}${_so64}
    ...
    if(TARGET ${target})
      message(WARNING "name: ${name} target: ${target} ARGN: ${ARGN}")
